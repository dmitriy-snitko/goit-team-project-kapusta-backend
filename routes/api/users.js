...
router.post('/verify', ctrlWrap(controllers.verify))
router.get('/verify/:verifyToken', ctrlWrap(controllers.verifyToken))
router.get('/', guard, controllers.getUserBalance)
router.get('/current', guard, ctrlWrap(controllers.getCurrent))
